...
<title>APP开发者平台</title>
	...
	<link href="<%=request.getContextPath() %>/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
	<!-- JQVMap -->
	<link href="<%=request.getContextPath() %>/css/jqvmap.min.css" rel="stylesheet" />
	<link href="<%=request.getContextPath() %>/css/dropzone.min.css" rel="stylesheet">
	<!-- Custom Theme Style -->
	<link href="<%=request.getContextPath() %>/css/custom.min.css"	rel="stylesheet">
	
	<!-- add localcss 2016-8-18 -->
	<link href='<%=request.getContextPath() %>/localcss/appinfoadd.css' rel='stylesheet'>
	<link href='<%=request.getContextPath() %>/localcss/appinfolist.css' rel='stylesheet'> 
</head>
			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="<%=request.getContextPath() %>/dev/flatform/main" class="site_title"><i class="fa fa-paw"></i> <span>APP
								BMS</span>
						</a>
					</div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="<%=request.getContextPath() %>/dev/flatform/app/list">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="<%=request.getContextPath() %>/servlet/devuser_Login"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="<%=request.getContextPath() %>/servlet/devuser_Login"><i
